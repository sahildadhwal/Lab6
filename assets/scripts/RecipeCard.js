// RecipeCard.js // added colon after all "todo" so my TODO extention highlights it
...
{ // bracket so I can close my side notes 
  /* 
  ...
  *                          "lengthTime": "string",
  *                          "ingredients": "string"
  // spanOutput.innerHTML = `Hello ${fNameEl.val} ${lNameEl.value}!`;    
  */
}
...
customElement.define('recipe-card', RecipeCard);
